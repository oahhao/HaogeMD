use haogemd_lib::commands::update::pick_platform_download_url;
use serde_json::json;

#[test]
fn pick_windows_assets_prefers_setup_exe() {
    let assets = json!([
        { "name": "HaogeMD-v0.4.0-portable.zip", "browser_download_url": "url-portable" },
        { "name": "HaogeMD-v0.4.0-x64-setup.exe", "browser_download_url": "url-setup" }
    ]);
...
fn pick_macos_assets_prefers_dmg() {
    let assets = json!([
        { "name": "HaogeMD-v0.4.0-macos.app.tar.gz", "browser_download_url": "url-tar" },
        { "name": "HaogeMD-v0.4.0-macos-universal.dmg", "browser_download_url": "url-dmg" }
    ]);
...
fn pick_linux_assets_prefers_appimage() {
    let assets = json!([
        { "name": "haogemd_0.4.0_amd64.deb", "browser_download_url": "url-deb" },
        { "name": "HaogeMD-v0.4.0-x86_64.AppImage", "browser_download_url": "url-appimage" }
    ]);
